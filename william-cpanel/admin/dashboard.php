...
try {
    ...
    // Buscar estatísticas
    $stats_agendamentos = $pdo->query("SELECT COUNT(*) as total FROM agendamentos")->fetch()['total'];
    $stats_clientes = $pdo->query("SELECT COUNT(*) as total FROM clientes")->fetch()['total'];
    $stats_funcionarios = $pdo->query("SELECT COUNT(*) as total FROM funcionarios WHERE status = 'ativo'")->fetch()['total'];
    $stats_pendentes = $pdo->query("SELECT COUNT(*) as total FROM agendamentos WHERE status = 'pendente'")->fetch()['total'];
    $stats_concluidos = $pdo->query("SELECT COUNT(*) as total FROM agendamentos WHERE status = 'concluido'")->fetch()['total'];
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-white shadow-lg min-h-screen">
            <nav class="mt-8">
                ...
                <a href="funcionarios.php" class="text-gray-600 hover:text-gray-900">Funcionários</a>
        ...
        <div class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <a href="clientes.php" class="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm">Total de Clientes</p>
                            <p class="text-2xl font-bold text-gray-900"><?php echo $stats_clientes; ?></p>
                        </div>
                ...
                <a href="funcionarios.php" class="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm">Funcionários Ativos</p>
                            <p class="text-2xl font-bold text-gray-900"><?php echo $stats_funcionarios; ?></p>
                        </div>
